...
import { TranscriptViewContainer, NoUserSelected, UsernamePanel, Username, PanelSegment,OnlineMarker } from "./styles";
  ...
  return <TranscriptViewContainer>
    <UsernamePanel>
      <PanelSegment>
        ...
        <OnlineMarker online={selectedUser.online}/>
      </PanelSegment>
      <PanelSegment>
        <Button text="Meet Now" />
      </PanelSegment>
    </UsernamePanel>
    <ConversationHistory selectedUser={selectedUser.username} />
  </TranscriptViewContainer>;
}
